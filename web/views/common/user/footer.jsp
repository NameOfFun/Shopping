            ...
            <div class="col-xl-3 col-md-6 col-sm-6 col-12 d-flex ">
                <div class="widgets-item">
                    ...
                    <div class="widgets-contacts">
                        <ul>
                            <li><a href="#" class="d-flex"><i class="fa-solid fa-location-dot"></i><span>Thạch Hòa, Thạch Thất, Hà Nội</span></a></li>
                            <li><a href="#" class="d-flex"><i class="fa-solid fa-envelope"></i> 12damhao@gmail.com</a></li>
                            <li><a href="#" class="d-flex"><i class="fa-solid fa-phone"></i> +84 978 775 882</a></li>
                        </ul>
                    </div>
