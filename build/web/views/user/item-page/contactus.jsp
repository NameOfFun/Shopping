    ...
    <body>
                                    ...
                                    <li>
                                        <a href="#" class="d-flex align-items-center">
                                            ...
                                            <div class="inner-text">
                                                <h6>Address</h6>
                                                <span>Thach Hòa, Thạc Thất, Hà Nội</span>
                                            </div>
                                        </a>
                                    </li>
                                    <li>
        ...
        <div class="map-section">
            <div class="container">
                ...
                <div id="map">
                    <iframe src="https://www.google.com/maps/d/u/0/embed?mid=1MSMqV1LpksnuBIHplq5corz-LpZ3b8M&ehbc=2E312F" width="1185" height="430" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                </div>
            </div>
        </div>
