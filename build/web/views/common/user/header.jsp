        ...
        <div class="container d-flex align-items-center justify-content-between">
            <div class="top-bar-contact d-flex align-items-center">
                <ul class="d-flex align-items-center">
                    <li><a href="#"><i class="fa-solid fa-phone"></i>+84 978 775 882</a></li>
                    <li><a href="mailto: nghiemxuanloc02@gmail.com" target="_blank"><i class="fa-regular fa-envelope"></i>12damhao@gmail.com</a></li>
                    <li><a href="https://www.google.com/maps/d/u/0/embed?mid=1MSMqV1LpksnuBIHplq5corz-LpZ3b8M&ehbc=2E312F" target="_blank"><i class="fa-sharp fa-solid fa-location-dot"></i>Locate Our Shop</a></li>
                </ul>
            </div>
